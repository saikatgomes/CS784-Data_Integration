...
<html>
  <header> <h2>Randomly generated ids from KBB and Craiglist to match</h2></header>
  ...
  <body>
	...
	echo "</td>";
	echo "<td><input class='match' id='{$id1}' type='button' value='MAYBE' onclick='Matched(this)' /></td>";
	echo "</tr>";
      }
    }
    echo "</table>";
